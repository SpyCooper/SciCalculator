...
public class Calculations
{
    ...
    public double sinh(double a, boolean degree)
    {
        // if degree is true, convert a to radians then return the degree value of sinh
        if (degree)
        {
            a = Math.toRadians(a);
        }
    ...
    public double cosh(double a, boolean degree)
    {
        // if degree is true, convert a to radians
        if (degree)
        {
    ...
    public double tanh(double a, boolean degree)
    {
        // if degree is true, convert a to radians
        if (degree)
        {
    ...
    public double csch(double a, boolean degree)
    {
        // if degree is true, convert a to radians
        if (degree)
        {
        ...
        double csch = 1 / Math.sinh(a);

        // Define a small tolerance value
        double tolerance = 1e-10;
        // If the result is less than the tolerance value, return 0
        if (Math.abs(csch) < tolerance)
        {
            return 0;
        }
    ...
    public double sech(double a, boolean degree)
    {
        // if degree is true, convert a to radians
        if (degree)
        {
        ...
        double sech = 1 / Math.cosh(a);

        // Define a small tolerance value
        double tolerance = 1e-10;
        // If the result is less than the tolerance value, return 0
        if (Math.abs(sech) < tolerance)
        {
            return 0;
        }
    ...
    public double coth(double a, boolean degree)
    {
        // if degree is true, convert a to radians
        if (degree)
        {
        ...
        double coth = 1 / Math.tanh(a);

        // Define a small tolerance value
        double tolerance = 1e-10;
        // If the result is less than the tolerance value, return 0
        if (Math.abs(coth) < tolerance)
        {
            return 0;
        }
    ...
    public double arcsinh(double a, boolean degree)
    {
        // if degree is true, convert a to radians
        if (degree)
        {
        ...
        double arcsinh = Math.log(a + Math.sqrt(a*a + 1));

        // Define a small tolerance value
        double tolerance = 1e-10;
        // If the result is less than the tolerance value, return 0
        if (Math.abs(arcsinh) < tolerance)
        {
            return 0;
        }
    ...
    public double arccosh(double a, boolean degree)
    {
        // if degree is true, convert a to radians
        if (degree)
        {
        ...
        double arccosh = Math.log(a + Math.sqrt(a*a - 1));

        // Define a small tolerance value
        double tolerance = 1e-10;
        // If the result is less than the tolerance value, return 0
        if (Math.abs(arccosh) < tolerance)
        {
            return 0;
        }
    ...
    public double arctanh(double a, boolean degree)
    {
        // if degree is true, convert a to radians
        if (degree)
        {
        ...
        double arctanh = 0.5 * Math.log((1 + a) / (1 - a));

        // Define a small tolerance value
        double tolerance = 1e-10;
        // If the result is less than the tolerance value, return 0
        if (Math.abs(arctanh) < tolerance)
        {
            return 0;
        }
    ...
    public double arccsch(double a, boolean degree)
    {
        // if degree is true, convert a to radians
        if (degree)
        {
        ...
        double arccsch = Math.log(1 / a + Math.sqrt(1 / (a*a) + 1));

        // Define a small tolerance value
        double tolerance = 1e-10;
        // If the result is less than the tolerance value, return 0
        if (Math.abs(arccsch) < tolerance)
        {
            return 0;
        }
    ...
    public double arcsech(double a, boolean degree)
    {
        // if degree is true, convert a to radians
        if (degree)
        {
        ...
        double arcsech = Math.log(1 / a + Math.sqrt(1 / (a*a) - 1));

        // Define a small tolerance value
        double tolerance = 1e-10;
        // If the result is less than the tolerance value, return 0
        if (Math.abs(arcsech) < tolerance)
        {
            return 0;
        }
    ...
    public double arccoth(double a, boolean degree)
    {
        // if degree is true, convert a to radians
        if (degree)
        {
        ...
        double arccoth = 0.5 * Math.log((a + 1) / (a - 1));

        // Define a small tolerance value
        double tolerance = 1e-10;
        // If the result is less than the tolerance value, return 0
        if (Math.abs(arccoth) < tolerance)
        {
            return 0;
        }
